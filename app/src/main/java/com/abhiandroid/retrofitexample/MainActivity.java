    ...
    private void getUserListData() {
        ...
        Api.getClient().getUsersList(new Callback<List<UserListResponse>>() {
            ...
            public void success(List<UserListResponse> userListResponses, Response response) {
                ...
                Toast.makeText(MainActivity.this, userListResponses.toString(), Toast.LENGTH_LONG).show();
                for(int i=0;i<userListResponses.size();i++)
                    Log.d("Check", String.valueOf(userListResponses.toString()));
